...
def countngrams(frequencies, order):
    ...
    articles = pd.read_csv('../csvbestanden/telegraafdata' + '.csv', sep="|", error_bad_lines=False)
...
if __name__ == '__main__':
    ...
    edge_highlight_color = 'darkmagenta'

    #Pick a color palette — Blues8, Reds8, Purples8, Oranges8, Viridis8
    color_palette = Purples8

    #Choose a title!
    title = 'Most common bigrams, de Telegraaf'

    #Establish which categories will appear when hovering over each node
    HOVER_TOOLTIPS = [("bigram", "@index")]
    ...
    plot = figure(tooltips = HOVER_TOOLTIPS,
                ...
                x_range=Range1d(-1, 1), y_range=Range1d(-1, 1), title=title)

    # G.tick_params(left=False, bottom=False, labelleft=False, labelbottom=False)
